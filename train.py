...
def train():
    ...
    dataloader_val = torch.utils.data.DataLoader(dataset_val, batch_size=batch_size, sampler=sampler_batch_val, num_workers=num_workers)

    classes = np.asarray(['__background__', 'text', 'structured_data', 'graphical_chart', 'title'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', help='path to training, val data, /opt/ml/input/data/ is the path required by sagemaker',
                        default='/opt/ml/input/data/', type=str)
